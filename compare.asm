...
; type >>> nasm -f obj compare.asm && bcc32 compare.obj driver.obj asm_io.obj && compare
...
_asm_main:
        ...
        jg      exit              ; jump when eax > input2 //jg = jump greater than jl = jump less than
        mov     eax, [input2]     ; else eax = input2 (input2 is greater)


exit: 
        mov    [max], eax         ; max = eax store max value after compare in max      
        mov    eax, result        ; print "The max is: "
        call   print_string       
        mov    eax, [max]         ; print max
        call   print_int
        call   print_nl           
